"""Frontend. Single self-contained HTML document served at /."""
      ...
      <section class="panel glow p-2 flex flex-col h-[55%] overflow-hidden relative">
        ...
        <div class="flex items-center justify-between mb-1 shrink-0 bg-black p-2 border border-[var(--border)] relative z-20">
          ...
          <div class="flex items-center gap-2 border-l border-gray-700 pl-4">
            ...
            <button id="advisorBtn" onclick="runAdvisor()" class="bg-cyan-600 hover:bg-cyan-500 text-black font-bold px-3 py-1 text-xs">AI ADVISOR</button>
            <button id="challengeBtn" onclick="challengeStrategy()" class="bg-rose-700 hover:bg-rose-600 text-white font-bold px-3 py-1 text-xs">CHALLENGE</button>
            <button id="metricsBtn" onclick="openPredictionMetrics()" class="bg-slate-700 hover:bg-slate-600 text-white font-bold px-3 py-1 text-xs">AI METRICS</button>
            ...
            <button id="optimizeBtn" onclick="runOptimizer()" class="bg-amber-600 hover:bg-amber-500 text-black font-bold px-3 py-1 text-xs">⚙ OPTIMIZE</button>
          </div>
        </div>
