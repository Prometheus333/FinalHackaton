...
<style>
  ...
  .login-box input:focus { border-color: #00ff9d; }
  .login-box button {
      width: 100%;
      padding: 12px;
      background: #00ff9d;
  ...
  .login-box button:hover { background: #00cc7d; }
  .error-msg { color: #ff4444; font-size: 12px; display: none; margin-top: 15px; }
</style>
</head>
<body class="text-gray-300 h-screen flex flex-col overflow-hidden text-xs">
  ...
  <div id="login-screen">
      <div class="login-box">
          <h2 style="margin-top:0; font-size: 1.5rem; letter-spacing: 2px;">🔒 AI TRADING DESK</h2>
          <p style="color: #a1a1aa; font-size: 12px; margin-bottom: 25px;">Enterprise Authentication Gateway</p>
          
          <input type="text" id="username" placeholder="Username" autocomplete="off">
          <input type="password" id="password" placeholder="Password" onkeypress="if(event.key === 'Enter') attemptLogin()">
